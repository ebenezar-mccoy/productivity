...
hi LineNr ctermfg=250 ctermbg=234 cterm=NONE guifg=#858581 guibg=#292927 gui=NONE
...
hi Normal ctermbg=NONE cterm=NONE guifg=#f8f8f2 guibg=#121210 gui=NONE
...
hi Identifier ctermfg=cyan ctermbg=NONE cterm=NONE guifg=#8ae5ef guibg=NONE gui=italic
...
hi NonText ctermfg=NONE ctermbg=NONE cterm=NONE guifg=bg guibg=bg gui=NONE
...
hi Special ctermfg=227 ctermbg=NONE cterm=NONE guifg=#f8f8f2 guibg=NONE gui=NONE
hi SpecialKey ctermfg=1 ctermbg=234 cterm=NONE guifg=#3b3a32 guibg=#292927 gui=NONE 
...
hi String ctermfg=186 ctermbg=NONE cterm=NONE guifg=#ffff66 guibg=NONE gui=NONE
...
hi rubyInterpolationDelimiter ctermfg=blue ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
...
hi rubyInstanceVariable ctermfg=cyan ctermbg=NONE cterm=NONE guifg=#00ffff guibg=NONE gui=NONE
hi rubyInclude ctermfg=72 ctermbg=NONE cterm=NONE guifg=#40a187 guibg=NONE gui=NONE
hi rubyGlobalVariable ctermfg=cyan ctermbg=NONE cterm=NONE guifg=#00ffff guibg=NONE gui=NONE
hi rubyRegexp ctermfg=186 ctermbg=NONE cterm=NONE guifg=#ffff66 guibg=NONE gui=NONE
...
hi rubyClassVariable ctermfg=cyan ctermbg=NONE cterm=NONE guifg=#00ffff guibg=NONE gui=NONE
...
hi rubyPseudoVariable ctermfg=cyan ctermbg=NONE cterm=NONE guifg=#00ffff guibg=NONE gui=NONE
