...
hi TabLineSel ctermfg=150 ctermbg=237

hi Cursor ctermfg=16 ctermbg=145 cterm=NONE guifg=#182227 guibg=#9ea7a6 gui=NONE
hi Visual ctermfg=NONE ctermbg=238 cterm=NONE guifg=NONE guibg=#3f4b52 gui=NONE
...
hi MatchParen ctermfg=170 ctermbg=NONE cterm=underline guifg=#dda790 guibg=NONE gui=underline
...
hi rubyInterpolationDelimiter ctermfg=12 ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
...
hi rubyStringDelimiter ctermfg=118 ctermbg=NONE cterm=NONE guifg=#8bb664 guibg=NONE gui=NONE
